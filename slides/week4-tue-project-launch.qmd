...
::: {.highlight-box}
**LLMs-in-the-loop:** metodologia che integra l'analisi automatizzata dei LLM con la **validazione sistematica umana**, trattando l'IA come un "codificatore" le cui classificazioni vengono verificate contro il giudizio umano [@marino2024].
:::

Fasi della pipeline:

1. **Definizione del codebook** — categorie di analisi e regole
2. **Prompting sistematico** — istruzioni strutturate al LLM
3. **Classificazione automatizzata** — il LLM analizza i dati
4. **Validazione umana** — campione codificato da umani
5. **Calcolo dell'affidabilità** — intercoder reliability IA-umano
6. **Iterazione** — raffinamento del prompt se necessario
