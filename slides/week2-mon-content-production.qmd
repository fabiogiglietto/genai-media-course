...
::: {.highlight-box}
**Risultato chiave:** La qualità è equivalente, ma solo il **29%** degli svizzeri leggerebbe notizie interamente generate dall'IA [@gilardi2025].
:::
...
La resistenza **non** dipende dalla qualità percepita, ma da preoccupazioni più profonde legate a **fiducia** e **autenticità**.
...
> "L'avversione pubblica alle notizie generate dall'IA non è una questione di qualità percepita, ma piuttosto un problema più ampio di fiducia e percezione."
>
> — @gilardi2025
